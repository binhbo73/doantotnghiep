...
export const DepartmentSchema = z.object({
    ...
    sub_department_count: z.number().int().nonnegative().default(0),
...
export const CitationSchema = z.object({
    ...
    grounding_score: z.number().optional(),
    overlap_score: z.number().optional(),
    retrieval_score: z.number().optional(),
    critical_facts: z.array(z.string()).optional(),
    matched_facts: z.array(z.string()).optional(),
    missing_facts: z.array(z.string()).optional(),
    type: z.string().optional(),
    asset_id: z.string().optional(),
    asset_caption: z.string().optional(),
    asset_image_path: z.string().optional(),
