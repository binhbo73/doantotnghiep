...
export function useFilePreview(file: File | null, options: UseFilePreviewOptions = {}) {
    ...
    useEffect(() => {
        if (!file) {
            setPreview({ url: null, type: 'unsupported', loading: false, error: null })
            return
        }
        ...
        try {
            ...
            setPreview({ url: objectUrl, type, loading: false, error: null })
            logger.debug('File preview generated', {
                fileName: file.name,
                type,
        ...
        return (
            <div className={`flex items-center justify-center bg-red-50 border border-red-200 rounded-lg p-4 ${className}`}>
                <div className="text-center">
                    <div className="text-red-500 text-sm mb-2">Preview Error</div>
    ...
    switch (preview.type) {
        ...
        default:
            return (
                <div className={`flex items-center justify-center bg-gray-100 rounded-lg ${className}`}>
                    <div className="text-center">
                        <div className="text-gray-500 text-sm mb-2">File</div>
